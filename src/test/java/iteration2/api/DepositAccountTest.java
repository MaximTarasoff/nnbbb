...
public class DepositAccountTest extends BaseTest {
    ...
    public void userCannotDepositMoneyToNotHisAccountTest() {
        ...
        List<Transaction> transactions = SessionStorage.getUserSteps().getAllAccountTransactions(ownAccount.getId()).stream().filter(transaction -> transaction.getType().contains("DEPOSIT") &&
